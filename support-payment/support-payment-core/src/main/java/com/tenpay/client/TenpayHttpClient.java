...
public class TenpayHttpClient {
    ...
    protected void callHttps() throws IOException, CertificateException, KeyStoreException,
        ...
        final File jksCAFile = new File(caPath + "/" + TenpayHttpClient.JKS_CA_FILENAME);
        if (!jksCAFile.isFile()) {
     ...
     * @throws IOException
     */
    protected void httpPostMethod(final String url, final byte[] postData) throws IOException {
    ...
    protected void httpGetMethod(final String url) throws IOException {
        ...
        final HttpURLConnection httpConnection = HttpClientUtil.getHttpURLConnection(url);
     ...
     * @throws IOException
     */
    protected void httpsGetMethod(final String url, final SSLContext sslContext) throws IOException {
     ...
     * @throws IOException
     */
    protected void doPost(final HttpURLConnection conn, final byte[] postData) throws IOException {
