...
public class ClientResponseHandler {
    ...
    public String getParameter(final String parameter) {
        final String s = this.parameters.get(parameter);
        return (null == s) ? "" : s;
    }
    ...
    public boolean isTenpaySign() {
        ...
        final Set<Map.Entry<String, String>> es = this.parameters.entrySet();
    ...
    protected void doParse() throws JDOMException, IOException {
        ...
        // 解析xml,得到map
        final Map<String, String> m = XmlUtil.doXmlParse(xmlContent);
