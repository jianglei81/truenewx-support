...
import cn.agilesemi.support.office.util.ExcelUtil;
...
public class ExcelSheet {
    ...
    public void mergeCells(int firstRowIndex, int firstColumnIndex, int lastRowIndex,
            int lastColumnIndex) {
        ExcelUtil.mergeCells(this.origin, firstRowIndex, firstColumnIndex, lastRowIndex,
                lastColumnIndex);
    }
